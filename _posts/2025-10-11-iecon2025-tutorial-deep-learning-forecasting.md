---
layout: single
title: "IECON 2025 Tutorial: Deep Learning for Energy Forecasting"
date: 2025-10-11
categories: [tutorials, conferences]
tags: [deep-learning, forecasting, energy-systems, IECON, machine-learning, time-series]
author_profile: true
excerpt: "Hands-on tutorial on deep learning-based forecasting methods for energy-related time series, covering fundamentals, hyperparameter tuning, and reproducibility best practices."
header:
...
**Lecturers:** 
- **Giuseppe La Tona** (CNR-INM, Italy) - [giuseppe.latona@cnr.it](mailto:giuseppe.latona@cnr.it)
...
- 📚 [Tutorial Page on IECON 2025 Website](https://iecon2025.org/tutorials/)
- 💻 [GitHub Repository](https://github.com/giulatona/iecon2025_tutorial)
- 📧 Contact: [giuseppe.latona@cnr.it](mailto:giuseppe.latona@cnr.it)

---

## 📍 For IECON 2025 Attendees
